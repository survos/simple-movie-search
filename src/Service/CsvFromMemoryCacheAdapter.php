 ...
 *
 */
class CsvFromMemoryCacheAdapter implements AdapterInterface, CacheInterface, LoggerAwareInterface, ResettableInterface
{
...
//        );
    ...
    {
        if (!$this->csvCache->contains($key)) {
            dd($key, '@todo: add the data via the callback.');
        }
